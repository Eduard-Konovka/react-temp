...
export default function Friends() {
  ...
  // Альтернатива visibleFriends для фильтров/сортировки очень больших сложных коллекций,
  // чтобы не перередерывать массив при изменении других стейтов вне зависимостей filter и friends.
